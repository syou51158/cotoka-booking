    ...
    <div style={{ padding: 24 }}>
      ...
      >
        ...
        <div>
          ...
          >
            <p>
              <strong>店名</strong>: {profile.salon_name}
            </p>
            <p>
              <strong>住所</strong>:{" "}
              {profile.address_ja ||
            ...
            <p>
              <strong>電話</strong>: {profile.phone || "(未設定)"}
            </p>
            <p>
              <strong>送信元メール</strong>: {profile.email_from}
            </p>
            <p>
              <strong>タイムゾーン</strong>: {profile.timezone}
            </p>
            <p>
              <strong>既定ロケール</strong>: {profile.default_locale}
            </p>
            <p>
              <strong>通貨</strong>: {profile.currency}
            </p>
            <p>
              <strong>Webサイト</strong>: {profile.website_url || "(未設定)"}
            </p>
            <p>
              <strong>マップURL</strong>: {profile.map_url || "(未設定)"}
            </p>
