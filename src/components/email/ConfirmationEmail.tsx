    ...
    >
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <tbody>
            ...
            <tr>
              ...
              >
                {formatDuration(
                  reservation.service?.duration_min || 60,
                  locale,
                )}
              </td>
            </tr>
      ...
      >
        ...
        <p style={{ margin: 0, fontSize: "14px", color: "#374151" }}>
          {dict.email.confirmation.registeredContact.email}:{" "}
          {reservation.customer_email}
        </p>
        {reservation.customer_phone ? (
          <p
            style={{ margin: "4px 0 0 0", fontSize: "14px", color: "#374151" }}
          >
            {dict.email.confirmation.registeredContact.phone}:{" "}
            {maskPhone(reservation.customer_phone)}
          </p>
        ) : null}
      </div>
